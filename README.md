...
To run the SHARPpy GUI and interact with real-time observed and forecast soundings, navigate to the runsharp folder within the SHARPpy download using the terminal and run the following command:
