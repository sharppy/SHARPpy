.. note::
    ...
    Click :ref:`here <sphx_glr_download_auto_examples_plot_sars.py>` to download the full example code
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: plot_sars.py <plot_sars.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: plot_sars.ipynb <plot_sars.ipynb>`
