...
class SPCWidget(QWidget):
    ...
    def __init__(self, **kwargs):
        ...
        self.brand = QLabel("{0:s} v{1:s} {2:s}".format(__brand__, __version__, __version_name__))
...
class SPCWindow(QMainWindow):
    ...
    def __initUI(self, **kwargs):
        ...
        self.parent().parent().parent().config_changed.connect(self.spc_widget.updateProfs)
        self.parent().parent().parent().config_changed.connect(self.updateConfig)
    ...
    def createMenuBar(self):
        ...
        pref.triggered.connect(self.parent().parent().parent().preferencesbox)
